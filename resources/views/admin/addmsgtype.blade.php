...
@section('css')
<title>添加类目</title>
<meta name="keywords" content="添加类目" />
<meta name="description" content="添加类目" />
      ...
      <div class="col-xs-12">
        ...
        <form class="form-horizontal" id="ajaxform"  action="{{URL::action('Admin\MsgTypeController@saveMsgType')}}" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="msgtype" id="form-field-1" placeholder="分类名称" class="col-xs-10 col-sm-5"  value=""/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="author" id="form-field-1" placeholder="发布人" class="col-xs-10 col-sm-5"  value=""/>
            </div>
          </div>
          <div class="space-4"></div>
